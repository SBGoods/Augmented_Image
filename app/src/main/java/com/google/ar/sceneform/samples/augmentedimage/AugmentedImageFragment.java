...
public class AugmentedImageFragment extends ArFragment {
  ...
  // matching.
  private static final String DEFAULT_IMAGE_NAME = "donut.png";
  ...
  private boolean setupAugmentedImageDatabase(Config config, Session session) {
    ...
    if (assetManager == null) {
      ...
      augmentedImageDatabase.addImage("boba.jpg", loadAugmentedImageBitmap(assetManager, "boba.jpg"));
      augmentedImageDatabase.addImage("donut.png", loadAugmentedImageBitmap(assetManager, "donut.png"));
